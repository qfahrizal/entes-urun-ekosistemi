...
export const productCategories: ProductCategoryDefinition[] = [
...

  {
    ...
    families: [
...

      {
        id: "svg-ahf",
        label:
          "Statik Var Generatör (SVG) & Aktif Harmonik Filtre (AHF)",
        productId: "svg-ahf",
      },
...

      {
        id: "sont-reaktorleri",
        label:
          "Şönt Reaktörleri (Endüktif Yük Reaktörü)",
  ...
  // ==================================================
  // 4. ENERJİ YÖNETİMİ DONANIM VE YAZILIMLARI
  // ==================================================
    ...
    families: [
      {
        ...
        label:
          "ENTES Enerji İzleme Yazılımları",
        productId:
...

  {
    ...
    families: [
...

      {
        ...
        label:
          "Toprak Kaçak Akım Röleleri ve Toroid Akım Trafoları",
        productId:
...

      {
        id: "surge-koruma",
        label:
          "Surge (Darbe) Gerilimi Koruma Cihazı",
...

  {
    ...
    families: [
...

      {
        ...
        label:
          "A Serisi Alçak Gerilim Akım Trafoları",
        productId:
...

      {
        ...
        label:
          "Clamp Tip Ayrılabilir Akım Trafoları",
        productId:
          "clamp-tip-ayrilabilir-akim-trafolari",
      },
