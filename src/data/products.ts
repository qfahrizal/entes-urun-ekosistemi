...
export const products: Product[] = [
...

  {
    ...
    description: "ENTES Frekansmetreler; elektrik sistemlerinde şebeke frekansının ölçülmesi ve izlenmesine yönelik kullanılan ölçüm cihazlarıdır.",
...

  {
    ...
    description: "ENTES NH Serisi Bıçaklı Sigortalar; elektrik devrelerinin aşırı yük ve kısa devre akımlarına karşı korunmasına yönelik ürün grubudur ve uygun AYR Serisi Yük Ayırıcılarla birlikte değerlendirilebilir.",
...

  {
    ...
    description: "ENTES A Serisi Alçak Gerilim Akım Trafoları; alçak gerilim güç dağıtım sistemlerindeki yüksek primer akımların ölçüm, enerji izleme ve kontrol cihazlarının kullanabileceği sekonder akım seviyelerine dönüştürülmesine yönelik ürün grubudur.",
...

  {
    ...
    description: "ENTES Clamp Tip Ayrılabilir Akım Trafoları; mevcut tesislerde iletken sökülmeden kolay montaj yapılarak akım bilgisinin uyumlu ölçüm, izleme ve kontrol cihazlarına aktarılmasına yönelik ürün grubudur.",
...

  {
    ...
    description: "ENTES 3 Fazlı Akım Trafoları; üç faz iletkeninin kompakt bir yapı üzerinden ölçülmesine ve akım bilgisinin uyumlu ölçüm, izleme ve kontrol cihazlarına aktarılmasına yönelik ürün grubudur.",
...

  {
    ...
    description: "ENTES CKR Koruma Rölesi; transformatör, motor, jeneratör ve enerji nakil hatlarının kısa devre ve toprak arızalarına karşı korunmasına yönelik kullanılan sekonder koruma ürünüdür.",
...

  {
    ...
    description: "ENTES Surge (Darbe) Gerilimi Koruma Cihazları; elektrik sistemlerinde oluşabilecek yüksek enerjili geçici darbe gerilimlerinin etkisini sınırlandırarak bağlı ekipmanların korunmasına yönelik ürün grubudur.",
